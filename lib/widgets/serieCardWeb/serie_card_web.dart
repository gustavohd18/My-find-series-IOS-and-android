...
import 'package:my_find_series_and_movies/pages/details/series_details.dart';
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: () => Navigator.push(context,MaterialPageRoute(builder: (context) => SeriesDetails(serie: serie,))),
        child: Column(
          children: [
            Expanded(
              child: Container(
